...
function NavbarTwo() {
  ...
  return (
    <div className='container-flued mb-2 row h-[100px] bg-white shadow-sm items-center position-reletive z-40'>
      ...
      <div className="col-10 flex items-center justify-center">
      ...
      <h3 className='fs16px flex gap-2 navtwoplaceholder'>Where do you want to stay? <p className='text-light-50 d-none d-lg-inline'>Search for Oto's, Cities, Offices, Locations...</p></h3>
      </div>
