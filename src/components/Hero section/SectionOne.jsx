    ...
    <div className='container-flued   my-5 d-none d-lg-block'>
      <div className="row h-[403px] h-Auto">
        ...
        <div className="col-12 col-lg-6 sectionOneRight ps-5">
          <div className="flex w-full justify-center pt-5">
            <h5 className='mt-5 ms-5 ps-5 text-capitalize'>Enjoy a warm and welcoming community where you <span>feel right at home from day one</span></h5>
          </div>
      ...
      <div className="row h-[403px]"> 
        ...
        <div className="col-12 col-lg-6 sectionOneRight ps-0">
          <div className="flex w-full justify-center pt-5">
            <h5 className='mt-5'>Skip the paperwork and extra costs—our services are 
        ...
        <div className="col-12 col-lg-6 sectionOneleft sectiontwo flex justify-end">
          <div className="herosectioncard">
           <div className='p-3 pt-5'>
           <h1 className='fw-light-extra mt-3text-uppercase'>Hassle-Free </h1>
           <h3 className='text-uppercase'>Brokerage</h3>
           </div>
          </div>
      ...
      <div className="row h-[403px]">
        ...
        <div className="col-12 col-lg-6 sectionOneleft sectionThird">
          <div style={{backgroundColor : `#BAD8DA`}} className="herosectioncard">
           <div className='p-3 pt-5'>
           <h1 className='fw-light-extra mt-3text-uppercase '>Brokerage</h1>
        ...
        <div className="col-12 col-lg-6 sectionOneRight ps-5">
          <div className="flex w-full justify-center pt-5">
            <h5 className='ps-5 ms-5'>Relish well-prepared meals and comfortable living spaces, all designed to enhance <span>Easy on <br /> your daily life.</span></h5>
          </div>
