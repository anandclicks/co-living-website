...
function Semifooter() {
  return (
    <div className='h-[308px] flex justify-center container-flued flex-col py-5 py-lg-0 semiFooter h-Auto  '>
      <div className="row quickLinks gap-5 gap-lg-3 justify-center">
        <div className="col-12 col-lg-2">
            <p className='fwnormal text-xs '>PG In Delhi</p>
          <ul className='list-unstyled flex flex-col gap-2 pt-2 '>
            <li className='fs13px '>PG In Delhi</li>
            <li className='fs13px '>Hotels In Delhi</li>
            <li className='fs13px '>Room for Rent in Delhi</li>
            <li className='fs13px '>Coliving In Delhi</li>
          </ul>
        </div>
        <div className="col-12 col-lg-2">
          ...
          <ul className='list-unstyled flex flex-col gap-2 pt-2'>
            ...
            <li className='fs13px '>Coliving In Noida</li>
          </ul>
        </div>
        <div className="col-12 col-lg-2">
          ...
          <li className='fs13px '>PG In Gurugram</li>
            ...
            <li className='fs13px '>Coliving In Gurugram</li>
          </ul>
        </div>
        <div className="col-12 col-lg-2">
          ...
          <ul className='list-unstyled flex flex-col gap-2 pt-2'>
            ...
            <li className='fs13px '>Coliving In Ghaziabad</li>
          </ul>
        </div>
        <div className="col-12 col-lg-2">
          ...
          <ul className='list-unstyled flex flex-col gap-2 pt-2'>
            ...
            <li className='fs13px '>Coliving In Greater Noida</li>
          </ul>
        </div>
      </div>
    </div>
