    ...
    <div className="Pagebtns w-full  bg-white flex justify-between  d-flex d-lg-none">
        ...
        <div className="row ">
          ...
          <div className="flex w-full justify-between items-center py-2 py-lg-5 h-Auto">
            <div className='flex gap-3 flex-col'>
              <h2 className='fs-3 text-black fwnormal'>Oto Scout House<i class="ri-heart-line ms-3 fw-light primeryColor"></i></h2>
        ...
        <div className='btn btn-outline-info btnPglocaion d-inline'>
          ...
          <div className="imageContainer w-full overflow-hidden">
            <img className='h-full w-full object-cover' src={`/Allcitiesindividualpgs/otoscouthousesec45/${imageNo}.jpg`} alt="" />
          ...
          <p className='primeryColor pb-5'>Home <i class="ri-arrow-right-s-line"></i> Noida <i class="ri-arrow-right-s-line"></i> All PG <i class="ri-arrow-right-s-line"></i> <span className='text-black'>Oto Scout House</span></p>
          </div>
           {/* about property  */}
           <div className="box ">
         ...
         <div className=" walletPart flex my-2 ps-0">
          ...
          <div className="col-12 col-lg-5 pgdesignRight py-5  ">
            <div className={`pgform ms-0 ms-lg-4 flex  formOfPgReletive d-none col-4 ${isfixed ? 'fixed' : 'scroll'} p-3 px-5`}>
...
export default OtoScoutHousePage