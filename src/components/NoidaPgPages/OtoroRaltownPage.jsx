    ...
    <div className='container-flued row2  pgdesigntwo  h-Auto'>
        <div className="row ">
          ...
          <div className="flex w-full justify-between items-center py-2 py-lg-5 h-Auto">
            <div className='flex gap-3 flex-col'>
              <h2 className='fs-3 text-black fwnormal'>Oto Royaltown  <i class="ri-heart-line ms-3 fw-light primeryColor"></i></h2>
        ...
        <div className='btn btn-outline-info btnPglocaion d-inline'>
          ...
          <div className="imageContainer w-full overflow-hidden">
            <img className='h-full w-full object-cover' src={`/Allcitiesindividualpgs/otoroyaltownsec45/${imageNo}.jpg`} alt="" />
          ...
          <p className='primeryColor pb-5'>Home <i class="ri-arrow-right-s-line"></i> Noida <i class="ri-arrow-right-s-line"></i> All PG <i class="ri-arrow-right-s-line"></i> <span className='text-black'>Oto royal towns</span></p>
          </div>
           {/* about property  */}
           <div className="box ">
...
export default OtoroRaltownPage