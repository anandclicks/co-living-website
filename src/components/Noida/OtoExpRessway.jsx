...
function OtoExpRessway() {
  ...
  return (
    <Link to={'/noida/otoexpressway'} className="pgCard rounded-xl overflow-hidden ">
            {/* img  */}
          <div className='imges'>
          <img  className="img h-[310px] w-full object-cover" src={`/Allcitiesindividualpgs/otoexpresswaysec128/${imageindex}.jpg`}/>
          ...
          <div className="title p-2 pt-3 h-[87px]">
            <h2 className='fs20pxb text-black'>Oto Express Way</h2>
            <p><span>Oto Express Way</span> in Sector 128</p>
          </div>
          <hr />
          {/* pricing  */}
          <div className="pricing flex justify-center row items-center h-[82px]">
            <div className='col-5'>
              ...
              <h2 className='fs17px text-black fwnormal'>₹14,000</h2>
            </div>
